...
```sh
uv tool install --from git+https://github.com/weskao/ai_accounts.git@v0.1.0 ai-accounts
```
...
```sh
uv tool install --reinstall --from git+https://github.com/weskao/ai_accounts.git@v0.1.0 ai-accounts
```
