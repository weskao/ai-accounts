...
- **Usage / table formatting**: [`codex_usage.py`](src/ai-accounts/codex_usage.py) (`UsageWindow`, `format_usage_window`, `align_usage_cells`, `format_unix_time_compact`) — imported by `gemini_accounts.py` and `claude_accounts.py`.
